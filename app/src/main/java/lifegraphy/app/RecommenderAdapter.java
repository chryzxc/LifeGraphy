...
public class RecommenderAdapter extends RecyclerView.Adapter<RecommenderAdapter.ViewHolder> {
    private List<RecommenderList> myListList;
    private Context ct;

    public RecommenderAdapter(List<RecommenderList> myListList, Context ct) {
        this.myListList = myListList;
        this.ct = ct;
    }

    public void updateList(List<RecommenderList> list){
        myListList = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        RecommenderList myList=myListList.get(position);
        ...
        holder.scoreLayout.setVisibility(VISIBLE);
        holder.teamScore.setText(String.valueOf(myList.getScore()));

        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ct, Production.class);
                intent.putExtra("production_id",myList.getId());
        ...
        databaseReference.child("production_teams").child(myList.getId()).addValueEventListener(productionListener);

        storageReference.child("production_teams/"+myList.getId()+"/logo/team_logo.jpg").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                ...
                holder.productionLogo.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("url", "production_teams/"+myList.getId()+"/logo/team_logo.jpg");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            scoreLayout = (ConstraintLayout) itemView.findViewById(R.id.scoreLayout);
            teamScore = (TextView) itemView.findViewById(R.id.teamScore);
